...
<%-- 
  ...
  - @(#)
  - Description: this page specifies Child car and Sku information listing 
  --%>
...
<display:table name="viewChildCars" cellspacing="0" cellpadding="0" requestURI=""  id="childCarID" pagesize="25"  class="table" >
    		    ...
    		    <display:column sortable="false" titleKey="outfit.remove"  style="width: 15%">
			    		<!-- <input type="hidden" name="removeFlag" id="chk_selector" class="chkbox" value="${viewChildCars[counter].carId}"/> --> 
			    		<a class="removeChildCar" href="removeChildCar.html?method=removeOutfitChild&ChildCarId=${childCarID.carId}">Remove</a>
				</display:column>
...
function setID()
{
	...
	{
		var text = $('.child_'+i).children('.x-panel-header').html('Child Car Id : '+idArray[i]);
	}
}
setID();
</script>