...
public class OpenCatalogRequestController extends BaseFormController {
	
    private transient final Log log = LogFactory.getLog(OpenCatalogRequestController.class);
