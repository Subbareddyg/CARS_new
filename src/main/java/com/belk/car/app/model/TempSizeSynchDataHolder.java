...
@NamedNativeQuery(name="temp_size_view",query="Select * from TMP_SIZE_RULES" ,resultClass = TempSizeSynchDataHolder.class)
@Entity
@Table (name = "TMP_SIZE_RULES")
@Cache(usage = CacheConcurrencyStrategy.READ_ONLY, include="all")
public class TempSizeSynchDataHolder extends BaseAuditableModel implements java.io.Serializable {

	private static final long serialVersionUID = -1223928293999999999L;
