...
@Entity
@Table(name = "FULFMNT_SERV_SHIP_OPT")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, include = "all")
public class FulfillmentServiceShippingOptions extends BaseAuditableModel
		implements
			java.io.Serializable {

	private static final long serialVersionUID = 6407077305047137977L;
	private CompositeKeyForFSShippingOptions compositeKeyForShippingOptionsId;
	...
	public CompositeKeyForFSShippingOptions getCompositeKeyForShippingOptionsId() {
		return compositeKeyForShippingOptionsId;
	}

	public void setCompositeKeyForShippingOptionsId(
			CompositeKeyForFSShippingOptions compositeKeyForShippingOptionsId) {
	...
	@Column(name = "ALLOW_SHIPPING_CARRIER_OPTION", nullable = true, length = 1)
