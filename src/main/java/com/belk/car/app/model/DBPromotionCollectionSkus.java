...
@Entity
@Table(name = "PROMO_COLLECTION_SKUS", uniqueConstraints = @UniqueConstraint(columnNames = {"PROD_CODE", "SKU_CODE" }))
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE, include="all")
public class DBPromotionCollectionSkus extends BaseAuditableModel implements java.io.Serializable{
	 ...
	 * 
	 */
	private DBPromotionCollectionSkusId id;
	private String prodCode;
	private String skuCode;

	public DBPromotionCollectionSkus() {
	}
	...
	public DBPromotionCollectionSkusId getId() {
		return this.id;
	}

	public void setId(DBPromotionCollectionSkusId id) {
		this.id = id;
	}
