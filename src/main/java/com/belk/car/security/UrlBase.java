 ...
 * @version
 */
public abstract class UrlBase implements Component {
    //~ Instance fields ========================================================
    ...
    /** Holds value of property onContextUrl */
    protected String onContextUrl;
     ...
     * @param string
     */
    public void setOnContextUrl(String string) {
        onContextUrl = string;
    }
