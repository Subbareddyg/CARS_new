...
<div class="userButtons">
	<secureurl:secureAnchor cssStyle="btn" name="UserEdit" title="Edit" localized="true" hideUnaccessibleLinks="true" arguments="${user.id},editUser,list"/>
	<c:choose>
		<c:when test="${not empty userSearchCriteria.criteriaAsQueryString}">	
			<secureurl:secureAnchor cssStyle="btn" name="UserSearch" title="Back"  localized="true" hideUnaccessibleLinks="true" arguments="${userSearchCriteria.criteriaAsQueryString}"/>
		</c:when>
		<c:otherwise>
			<secureurl:secureAnchor cssStyle="btn" name="UserDetailsBack" title="Back"  localized="true" hideUnaccessibleLinks="true" arguments=""/>
		</c:otherwise>
	</c:choose>
	<secureurl:secureAnchor cssStyle="btn" name="ResetPassword" title="Reset Password"  localized="true" hideUnaccessibleLinks="true" arguments="${user.username}"/>
</div>
<ul class="user_info">
