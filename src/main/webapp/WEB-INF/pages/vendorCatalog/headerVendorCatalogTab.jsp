...
<div  id="tabArea">
    ...
    <%
            ...
            String isDataMappingAccess = (String) session.getAttribute("isDataMappingAccess");

   
            if (null != catalog) {
            	if(catalog.getStatusCD().equals("Importing")) {%>
    				<a id="tab2" class="tab" style="margin-top:0;" href="#" id="a_view_all" disabled="true">Data Mapping</a>
                                <% } else if(isDataMappingAccess!=null && isDataMappingAccess.equals("true")) {%>
