...
<display:table name="${activeCarRequestedImages}" export="false" cellpadding="0" cellspacing="0" id="carImage">
	...
	<display:column style="width:20%;"  sortable="false" title="Requested Image Note">
	  <div style="width:200px;overflow:auto;word-wrap:break-word;">
	  	<c:out value="${detailCar.carImages.image.description}"/>
	  </div>
  	</display:column>
	<display:column style="width:200px;" class="img_loc" sortable="false" title="Image Location">
	<div style="width:200px;overflow:auto;word-wrap:break-word;">
